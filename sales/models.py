"""
Models de vendas para ProjetoRavenna.
...
class ItemVenda(TenantModel):
    ...
    def save(self, *args, **kwargs):
        ...
        IMPORTANTE: Se preco_unitario não for fornecido, usa o preço
        atual do produto (snapshot).
        """
        # Faz snapshot do preço se não foi fornecido
